    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-6">
        <div className="max-w-sm text-center space-y-3">
          ...
          <Link to="/auth" search={{ next: "/pricing" }} className="inline-block rounded-md bg-primary px-4 py-2 text-sm text-primary-foreground">
            Sign in
          </Link>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-4 max-w-3xl mx-auto">
            {[
              ...
              return (
                ...
                >
                  {plan.save && (
                    <span className="absolute -top-2 right-4 rounded-full bg-emerald-600 text-primary-foreground text-[10px] uppercase tracking-wide px-2 py-0.5">
                      {plan.save}
                    </span>
                  )}

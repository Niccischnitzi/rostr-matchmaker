  ...
  return (
    <div className="max-w-2xl mx-auto px-4 pt-6 lg:pt-10">
      ...
      <div className="relative">
        {top ? (
          <div key={top.id} className="hover-spin-ring relative rounded-3xl border border-border bg-card overflow-hidden shadow-2xl flex flex-col soft-rise animate-fade-in">
